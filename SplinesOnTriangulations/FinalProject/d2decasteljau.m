function b = d2decasteljau(B,U) %TODO optimise 2d casteljau
% Description:
%  Computes the blossom of a degree 2 polynomial in two variables.
%
% Input parameters:
%  B    table of size 3 x 3 representing the coefficients of a
